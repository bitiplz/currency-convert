...
export default function Converter( props ) {
  ...
  return (
    <div>
      <CurrencyList data={ currencies } selected={ from } onSelect={ e => setSelection({ from: e.target.value }) } />
      ...
      <CurrencyList data={ currencies } selected={ to } onSelect={ e => setSelection({ to: e.target.value }) } />
    </div>
  );
}
